...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderEmployees(data) {
        ...
        pageData.forEach((employee, index) => {
            ...
            <tr>
                <td>${start + index + 1}</td>
                <td> <img class="profile-img" src="http://localhost:3000/avatars/${employee.avatar}"
              ...
              <button class="more_button"><strong>...</strong><i class="fa-solid fa-ellipsis"></i></button>
                <div class="dropdown-menu">
                    <div class="dropdown-item">
                        <button class="action-btn" onclick="viewEmpDetails('${employee.id}')"><span><i class="fa-regular fa-eye"></i></span> View Details</button>
    ...
    window.editEmployeeDetails = function (id) {
...
console.log(employee);
                        document.querySelector('.profile-edit').src = `http://localhost:3000/avatars/${employee.avatar}`;
    ...
    document.getElementById("delclosebtn").addEventListener("click", deleteformclose);
    ...
    function getAge(dateString) {
        // Split and parse the date (assuming dd-mm-yyyy format)
    ...
    window.viewEmpDetails = function (id) {
        fetch(`http://localhost:3000/employees/${id}`, {
            method: "GET",
            headers: { "content-Type": "application/json" },
            body: JSON.stringify()
            ...
            .then(employee => {
                ...
                detailOverlay.style.visibility = "visible",
                 ...
                 document.querySelector('.profile-pic-edit').src = `http://localhost:3000/avatars/${employee.avatar}`;
                document.getElementById("detail-name").innerText = `${employee.salutation} ${employee.firstName} ${employee.lastName}`
                ...
                document.getElementById("detail-age").innerText = getAge(employee.dob)
    ...
    function viewformclose() {
        ...
        document.getElementById("overlayDetail").style.opacity = 0;
